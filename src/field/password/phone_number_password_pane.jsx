...
import { humanLocation, setPhoneNumber, phoneNumberWithDiallingCode } from '../phone_number';
...
export default class PhoneNumberPasswordPane extends React.Component {
  handlePhoneNumberChange = e => {
    swap(
      ...
      function(m, str) {
        m = setPhoneNumber(m, str, 'phoneNumber');
...
PhoneNumberPasswordPane.propTypes = {
